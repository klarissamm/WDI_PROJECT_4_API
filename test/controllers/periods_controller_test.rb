...
class PeriodsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create period" do
    assert_difference('Period.count') do
      post periods_url, params: { period: { bleeding: @period.bleeding, date: @period.date, pain: @period.pain, user_id: @period.user_id } }, as: :json
    end
  ...
  test "should update period" do
    patch period_url(@period), params: { period: { bleeding: @period.bleeding, date: @period.date, pain: @period.pain, user_id: @period.user_id } }, as: :json
    assert_response 200
  end
